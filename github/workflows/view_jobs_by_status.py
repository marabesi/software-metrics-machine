...
def _split_and_normalize(val: str):
...
def count_delivery_by_day(jobs, job_name: str):
...
def count_delivery_by_week(jobs, job_name: str):
...
def main(job_name: str, workflow_name: str | None = None, out_file: str | None = None, with_pipeline: bool = False, aggregate_by_week: bool = False, _cli_filters: dict = {}) -> None:
    ...
    if event_vals := _split_and_normalize(_cli_filters.get('event')):
    ...
    if target_vals := _split_and_normalize(_cli_filters.get('target_branch')):
    ...
    if aggregate_by_week:
        ...
        dates, conclusions, matrix = count_delivery_by_day(jobs, job_name=job_name)
...
if __name__ == "__main__":
    ...
    # populate CLI filters used within main
    # module-scoped holder for parsed CLI filters used by main
    _cli_filters: dict = {}
