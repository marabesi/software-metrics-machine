...
def plot_top_authors(pairs: List[Tuple[str, int]], title: str = "Top PR authors", out_file: str | None = None) -> None:
    if not pairs:
...
if __name__ == "__main__":
    ...
    plot_top_authors(top, title=f"Top {len(top)} PR authors", out_file=args.out_file)
